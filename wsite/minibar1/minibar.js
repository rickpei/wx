...
var Zepto = function () {
    ...
    window.Zepto = Zepto, "$" in window || (window.$ = Zepto), function (a) {
        ...
        }, accepts: { script: "text/javascript, application/javascript", json: jsonType, xml: "application/xml, text/xml", html: htmlType, text: "text/plain" }, crossDomain: !1, timeout: 0, processData: !0, cache: !0
    ...
    function getWlnPath(js) {
        ...
        for (var i = 0, l = scripts.length; i < l; i++) {
            ...
            if (src.indexOf("minibar.js") != -1) {
                __ele = scripts[i];
                var ss = src.split("minibar.js"); path = ss[0]; break;
            }
        }
